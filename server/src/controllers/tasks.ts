...
export class TaskController {
  ...
  static async getProjectTasks(req: Request<{ projectId: string }>, res: Response): Promise<Response> {
    try {
  ...
  static async createTask(req: Request<{}, {}, CreateTaskRequest>, res: Response): Promise<Response> {
    try {
  ...
  static async moveTask(
    req: Request<{ id: string }, {}, MoveTaskRequest>, 
    res: Response
  ): Promise<Response> {
    try {
